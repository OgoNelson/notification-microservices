...
async function registerPlugins() {
  ...
  await server.register(import("@fastify/swagger"), {
    swagger: {
      info: {
        ...
        description: "API Gateway for Notification Microservices",
        version: "1.0.0",
        contact: {
          name: "API Support",
  ...
  server.decorate(
    "authenticate",
    async function (this: any, request: any, reply: any) {
      try {
  ...
  // Register routes
  server.register(import('./routes/notifications'))
}
...
server.get(
  ...
  async (request, reply) => {
    return {
      message: "Notification API Gateway is running",
      service: "api-gateway",
      version: "1.0.0",
    };
  }
